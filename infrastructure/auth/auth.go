...
func (tk *ClientData) CreateAuth(ctx context.Context, userid uint64, td *TokenDetails) error {
...
func (tk *ClientData) FetchAuth(ctx context.Context, tokenUuid string) (uint64, error) {
...
func (tk *ClientData) DeleteTokens(ctx context.Context, authD *AccessDetails) error {
...
func (tk *ClientData) DeleteRefresh(ctx context.Context, refreshUuid string) error {
	//delete refresh token
